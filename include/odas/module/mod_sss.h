...
#define __ODAS_MODULE_SSS
    ...
    */
    ...
    typedef struct sss_track_spectrum_obj {
    ...
    typedef struct mod_sss_obj {
        ...
        sss_track_spectrum_obj *trackSpectra;
    ...
    void push_track_to_buffer(mod_sss_obj* obj, msg_tracks_obj* tracks,int debug);
