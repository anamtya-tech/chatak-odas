...
typedef struct src_hops_obj {
    ...
    double frameDurationSec;    // hopSize / fS, e.g. 0.008s
    uint64_t syntheticTimeUs;   // running
    ...
    uint64_t *timeStamps;       // Array of parsed timestamps
    int numTimeStamps;          // Total number of timestamps
    int timeStampIndex;         // Current index during playback
