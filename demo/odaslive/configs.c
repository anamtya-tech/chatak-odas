    ...
    configs * configs_construct(const char * file_config) {
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+  
                ...
                cfgs->mod_chatak_stft_config = parameters_mod_chatak_stft_config(file_config);  // moongoose

            // +------------------------------------------------------+
            // | Message                                              |
            // +------------------------------------------------------+  

                cfgs->msg_chatak_id_spectra_config = parameters_msg_chatak_id_spectra_config(file_config);  // moongoose
    ...
    void configs_destroy(configs * cfgs) {
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+  
                ...
                mod_chatak_cfg_destroy(cfgs->mod_chatak_stft_config);  // moongoose
                
            // +------------------------------------------------------+
            // | Message                                              |
            // +------------------------------------------------------+  

                msg_chatak_id_cfg_destroy(cfgs->msg_chatak_id_spectra_config);  // moongoose
