...
#define __DEMO_OBJECTS
    ...
    typedef struct objects {
        ...
        mod_chatak_obj * mod_chatak_stft_object; // moongoose
        con_chatak_id_obj * con_chatak_id_spectra_object; // moongoose
    ...
    typedef struct aobjects {
        ...
        amod_chatak_obj * amod_chatak_stft_object;   // moongoose
        acon_chatak_id_obj * acon_chatak_id_spectra_object;  // moongoose        
