    ...
    void threads_multiple_start(aobjects * aobjs) {
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+  
                ...
                thread_start(aobjs->amod_chatak_stft_object->thread);    // moongoose

            // +------------------------------------------------------+
            // | Connector                                            |
            // +------------------------------------------------------+                     

                thread_start(aobjs->acon_chatak_id_spectra_object->thread);  // moongoose
    ...
    void threads_multiple_join(aobjects * aobjs) {
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+  
                ...
                thread_join(aobjs->amod_chatak_stft_object->thread);   // moongoose

            // +------------------------------------------------------+
            // | Connector                                            |
            // +------------------------------------------------------+  

                thread_join(aobjs->acon_chatak_id_spectra_object->thread); // moongoose
